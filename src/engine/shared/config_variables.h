...
MACRO_CONFIG_INT(SvStrictSpectateMode, sv_strict_spectate_mode, 0, 0, 2, CFGFLAG_SERVER, "0 - show health and armor always; 1 - show only for followed player; 2 - show never")
